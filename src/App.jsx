...
function InvPage({t,mob,invData,invShop,invTrend,invFeeMonthly}){
  ...
  return<div>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(130px,1fr))",gap:12,marginBottom:16}}>
      <KpiCard title="FBA Stock" value={N(d.fbaStock||0)} icon="" t={t} tip={TIPS.fbaStock}/><KpiCard title="Available" value={N(d.availableInv||0)} icon="#" t={t} tip={TIPS.invAvail}/><KpiCard title="Reserved" value={N(d.reserved||0)} icon="R" t={t} tip={TIPS.invReserved}/><KpiCard title="Critical SKUs" value={N(d.criticalSkus||0)} icon="!" t={t} tip={TIPS.invCritical}/><KpiCard title="Inbound" value={N(d.inbound||0)} icon="→" t={t} tip={TIPS.invInbound}/><KpiCard title="Avg Days Supply" value={Math.round(d.avgDaysOfSupply||0)} icon="" t={t} tip={TIPS.invDaysSupply}/><KpiCard title="Storage Fee" value={$2(fee)} icon="" t={t} tip={TIPS.storageFee}/>
    </div>
